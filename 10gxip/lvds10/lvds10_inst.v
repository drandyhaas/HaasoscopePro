	lvds10 u0 (
		.rx_in         (_connected_to_rx_in_),         //   input,   width = 14,         rx_in.export
		.rx_out        (_connected_to_rx_out_),        //  output,  width = 140,        rx_out.export
		...
		.rx_dpa_locked (_connected_to_rx_dpa_locked_), //  output,   width = 14, rx_dpa_locked.export
