module lvds10_altera_lvds_core20_191_lfyhyui #(
   ...
   input  logic [139:0]    tx_in,
   output logic [13:0]     tx_out,
   output logic            tx_outclock,
   output logic            tx_coreclock,
   input  logic [13:0]     rx_in,
   output logic [139:0]    rx_out,
   input  logic [13:0]     rx_bitslip_reset,
   input  logic [13:0]     rx_bitslip_ctrl,
   output logic [13:0]     rx_bitslip_max,
   ...
   output logic [13:0]     rx_dpa_locked,
   input  logic [13:0]     rx_dpa_hold,
   input  logic [13:0]     rx_dpa_reset,
   input  logic [13:0]     rx_fifo_reset,
   output logic [13:0]     rx_divfwdclk,
   input  logic [13:0]     loopback_in,
   output logic [13:0]     loopback_out,
