...
## 50MHz FPGA main clock (usually generated by oscillator) - lying and saying it's 40 MHz!
create_clock -name clk50 -period  25.000  [get_ports clk50]

## 12.5MHz LED clock - lying and saying it's 10 MHz so it's in sync with clk50
create_clock -name clk_over_4 -period  100.000  [get_nodes command_processor:inst1|clk_over_4]
