...
class MainWindow(TemplateBaseClass):
    ...
    def twochan(self):
        ...
        self.setupchannels()
        self.doleds()
        for usb in self.usbs: setupboard(usb,self.dopattern,self.dotwochannel,self.dooverrange)
    ...
    def setup_connection(self, board):
        ...
        if not hasattr(self,"firmwareversion") or self.firmwareversion is None: self.firmwareversion = ver
